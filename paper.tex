...
The remaining 32 galaxies constitute the `isolated field sample', for which we measured morphological parameters using {\scriptsize GALFIT} to fit exponential disks to the {\em HST} imaging (see \cref{subsubsec:galfitting} and Table \ref{tab:phys-props}) and derived beam-smearing corrected measurements of the rotation velocities extracted at $2R_{1/2}$ and the intrinsic velocity dispersions (see \cref{subsec:3d_modelling} and Table \ref{tab:kin_props}). \\
...
\begin{figure*}
    ...
    \caption{We plot the kinematic grids for the 13/32 isolated field sample galaxies classified as rotation-dominated.
